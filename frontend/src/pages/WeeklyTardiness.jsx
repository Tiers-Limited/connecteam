                    ...
                    <div className="flex items-center gap-2 border-l border-slate-200 pl-3">
                        ...
                        onClick={() => {
                          ...
                          const dataRows = employeeRows.map((rec) => {
                            ...
                            return [
                              ...
                              ...dateColumns.map((col) =>
                                sanitizeForExport(
                                  formatDayCell(rec.byDate[col.dateKey]),
                                ),
                              ),
                              String(rowTotal),
                          ...
                          const totalTardinessLabel = sanitizeForExport(
                            `Total tardiness (${formatDate(rangeStart)} – ${formatDate(rangeEnd)})`,
                          );
                          const summaryHeaderRow = [
                            "",
                            ...dateColumns.map((c) =>
                              sanitizeForExport(c.label),
                            ),
                            "Total",
                            "",
                            "",
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          exportTableToPDF(
                            sanitizeForExport(
                              `Weekly Tardiness ${formatDate(rangeStart)} ${formatDate(rangeEnd)}`,
                            ),
                            headers.map(sanitizeForExport),
                            rows,
